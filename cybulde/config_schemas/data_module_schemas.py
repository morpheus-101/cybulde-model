...
class ScrappedDataTextClassificationDataModuleConfig(TextClassificationDataModuleConfig):
    batch_size: int = 32
    train_df_path: str = "gs://rbd-mlflow/data/processed/rebalanced_splits/train.parquet"
    dev_df_path: str = "gs://rbd-mlflow/data/processed/rebalanced_splits/dev.parquet"
    test_df_path: str = "gs://rbd-mlflow/data/processed/rebalanced_splits/test.parquet"
